...
def agg_interface_summary(rows):
    ...
    for (pdb, asm, iid), g in groups.items():
        ...
        out.append({
            ...
            # PISA interface energetics + counts (constant per interface; read from any bond row).
            "interface_area": g[0].get("interface_area"),
            "solvation_energy": g[0].get("solvation_energy"),
            "stabilization_energy": g[0].get("stabilization_energy"),
            "p_value": g[0].get("p_value"),
            "number_interface_residues": g[0].get("number_interface_residues"),
            "number_hydrogen_bonds": g[0].get("number_hydrogen_bonds"),
            "number_salt_bridges": g[0].get("number_salt_bridges"),
            "number_disulfide_bonds": g[0].get("number_disulfide_bonds"),
            "number_covalent_bonds": g[0].get("number_covalent_bonds"),
            "number_other_bonds": g[0].get("number_other_bonds"),
