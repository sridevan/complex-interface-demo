...
export default function ComplexInterfaceApp({ config = {} }) {
  ...
  // so no chain-id remapping is needed.
  const cifSrc = (inst) => remoteCif
    ? { cifUrl: `https://files.rcsb.org/download/${inst.entry_id}-assembly${inst.assembly_id}.cif` }
      ...
      <div className="ex-row ex-row2">
        ...
        <div className="card ex-cell">
          ...
          <p className="note">For the selected instance: residues from the first component are shown on the left
            ...
            residue to highlight it here and in the 3D view; click it again to clear.</p>
